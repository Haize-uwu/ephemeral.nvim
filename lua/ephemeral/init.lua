...
local config = {
	ui = {
		...
		transparent_background = if_nil(vim.g.ephemeral_transparent_background, false),
		pumblend = {
			enable = if_nil(vim.g.ephemeral_pumblend_enable, false),
			transparency_amount = if_nil(vim.g.ephemeral_pumblend_transparency, 20),
		},
	},
	plugins = {
		neorg = if_nil(vim.g.ephemeral_plugin_neorg, true),
		barbar = if_nil(vim.g.ephemeral_plugin_barbar, false),
		telescope = if_nil(vim.g.ephemeral_plugin_telescope, false),
		neogit = if_nil(vim.g.ephemeral_plugin_neogit, true),
		nvim_tree = if_nil(vim.g.ephemeral_plugin_nvim_tree, true),
		dashboard = if_nil(vim.g.ephemeral_plugin_dashboard, true),
		startify = if_nil(vim.g.ephemeral_plugin_startify, true),
...
ephemeral.set_colorscheme = function()
	-- Set UI options
	------------------
	...
	set_hl("Class", { fg = dark_theme and palette.violet or palette.red })
	set_hl("StorageClass", { fg = dark_theme and palette.violet or palette.red })
